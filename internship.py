...
math_score_input = st.number_input("Enter the actual math score:", min_value=0, max_value=100, value=50)
...
if st.button("Predict"):
    ...
    # Calculate the actual math score
    actual_math_score = math_score_input
